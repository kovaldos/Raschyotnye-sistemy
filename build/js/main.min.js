...
/* harmony import */ var _modules_change_h1_text__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/change-h1-text */ "./js/modules/change-h1-text.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    // initChangeH1Text();
    Object(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_4__["initBurgerMenu"])();
    Object(_modules_dropdown__WEBPACK_IMPORTED_MODULE_6__["initDropdown"])();
...
var initBurgerMenu = function initBurgerMenu() {
  ...
  if (iconMenu) {
    ...
    var slider = document.querySelector('.work-with-us__slider');
...
/***/ "./js/modules/change-h1-text.js":
/*!**************************************!*\
  !*** ./js/modules/change-h1-text.js ***!
  \**************************************/
/*! exports provided: initChangeH1Text */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeH1Text", function() { return initChangeH1Text; });
// Change main heading inner text on mobile - Start
var initChangeH1Text = function initChangeH1Text() {
  var h1 = document.querySelector('.main-heading__title');
...
var initDropdown = function initDropdown() {
  var helpBlock = document.querySelector('.header__help-block');

  if (helpBlock) {
    var helpBtn = helpBlock.querySelector('.header__btn-help');
    var dropdownBlock = helpBlock.querySelector('.header__dropdown-block');
    var closeBtn = helpBlock.querySelector('.header__dropdown-btn-close');
...
var initPartnersSlider = function initPartnersSlider() {
  var swiper01 = document.querySelector('.work-with-us__slider');
